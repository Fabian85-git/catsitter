        ...
        <>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 bg-background rounded-t-3xl max-h-[85vh] overflow-hidden animate-in slide-in-from-bottom duration-300">
            <div className="sticky top-0 bg-background border-b px-4 py-4 flex items-center justify-between">
              <h2 className="text-xl font-bold">Über Tommy</h2>
            ...
            <div className="overflow-y-auto max-h-[calc(85vh-64px)] px-4 py-6">
              <p className="text-base leading-relaxed">
                Hallo! Ich bin Tommy und arbeite im Homeoffice, daher kann ich mich gut um Katzen kümmern. Mein Kater
                Jesus ist sehr sozial und freut sich immer über Besuch von anderen Katzen. Er ist drei Jahre alt und ein
                richtiger Schmusekater.
                <br />
                <br />
                Da ich den ganzen Tag zu Hause bin, kann ich mich intensiv um Besucherkatzen kümmern und habe immer ein
                Auge auf sie. Meine Wohnung ist katzengerecht eingerichtet mit Kratzbäumen, Spielzeug und gemütlichen
                Schlafplätzen. Jesus ist sehr entspannt und versteht sich gut mit anderen Katzen. Er liebt es zu spielen
                und ist auch mal für eine ausgedehnte Kuscheleinheit zu haben.
              </p>
            </div>
          </div>
        </>
