  ...
  const reviews = [
    {
      ...
      name: "Sandra",
      rating: 5,
      comment: "Charly ist fantastisch! Meine Katzen haben ihn sofort ins Herz geschlossen.",
      date: "vor 1 Woche",
    },
    {
      id: 2,
      name: "Esmeralda",
      rating: 4,
      comment: "Sehr gute Erfahrung. Charly ist zuverlässig und kommunikativ.",
      date: "vor 3 Wochen",
    },
  ]
      ...
      <main className="px-4 py-6 max-w-screen-xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            ...
            <span className="text-xl font-semibold">4.6 (12)</span>
          </button>
          <div className="flex items-center gap-2">
            <span className="text-lg font-semibold text-primary">CHF 50/Tag</span>
            <span className="px-3 py-1 rounded-full bg-[#5682D3] text-white text-xs font-medium">Bezahlt</span>
          </div>
        </div>

        <h1 className="text-3xl font-bold mb-4">Charly</h1>
        ...
        <div className="flex items-start gap-3 mb-8 text-muted-foreground">
          ...
          <span>Badenerstrasse (ca. 210m entfernt)</span>
        </div>
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="text-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden mb-2">
                <Image src="/orange-tabby-cat.jpg" alt="Tom" fill className="object-cover" />
              </div>
              <p className="font-semibold">Tom, 4jr.</p>
            </div>
            <div className="text-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden mb-2">
                <Image src="/grey-white-cat.jpg" alt="Speedy" fill className="object-cover" />
              </div>
              <p className="font-semibold">Speedy, 2jr.</p>
            </div>
            <div className="text-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden mb-2">
                <Image src="/fluffy-persian-cat.jpg" alt="Sylvester" fill className="object-cover" />
              </div>
              <p className="font-semibold">Sylvester, 6jr.</p>
            </div>
          </div>
        </div>

        <div className="space-y-3">
          <Link href="/sitter/connect/charly/message" className="block">
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 bg-background rounded-t-3xl max-h-[85vh] overflow-hidden animate-in slide-in-from-bottom duration-300">
            ...
            <div className="overflow-y-auto max-h-[calc(85vh-64px)] px-4 py-4">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b">
                <div className="text-center">
                  <div className="text-5xl font-bold mb-1">4.6</div>
                  <div className="flex gap-1 mb-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="w-5 h-5 fill-yellow-500 text-yellow-500" />
                    ))}
                  </div>
                  <div className="text-sm text-muted-foreground">12 Bewertungen</div>
                </div>
              </div>
