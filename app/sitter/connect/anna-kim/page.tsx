  ...
  const reviews = [
    {
      ...
      name: "Sandra",
      rating: 5,
      comment: "Anna und Kim sind ein tolles Team! Unsere Katzen waren super glücklich und gut betreut.",
      date: "vor 2 Wochen",
    },
    {
      id: 2,
      name: "Tommy",
      rating: 5,
      comment: "Sehr professionell und liebevoll. Kann ich nur weiterempfehlen!",
      date: "vor 1 Monat",
    },
    {
      id: 3,
      name: "Charly",
      rating: 5,
      comment: "Perfekt! Die beiden haben sich wunderbar um meine Katzen gekümmert.",
      date: "vor 2 Monaten",
    },
  ]
      ...
      <main className="px-4 py-6 max-w-screen-xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            ...
            <span className="text-xl font-semibold">5.0 (25)</span>
          </button>
          <span className="px-3 py-1 rounded-full bg-[#5682D3] text-white text-xs font-medium">Tausch</span>
        </div>

        <h1 className="text-3xl font-bold mb-4">Anna & Kim</h1>
        ...
        <div className="flex items-start gap-3 mb-8 text-muted-foreground">
          ...
          <span>Badenerstrasse (ca. 120m entfernt)</span>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-6">
            <div className="text-center">
              ...
              <p className="font-semibold">Joe, 2jr.</p>
            </div>
            <div className="text-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden mb-2">
                <Image src="/grey-white-cat.jpg" alt="Zen" fill className="object-cover" />
              </div>
              <p className="font-semibold">Zen, 2jr.</p>
            </div>
          </div>
        </div>

        <div className="space-y-3">
          <Link href="/sitter/connect/anna-kim/message" className="block">
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 bg-background rounded-t-3xl max-h-[85vh] overflow-hidden animate-in slide-in-from-bottom duration-300">
            ...
            <div className="overflow-y-auto max-h-[calc(85vh-64px)] px-4 py-4">
              <div className="flex items-center gap-4 mb-6 pb-6 border-b">
                <div className="text-center">
                  <div className="text-5xl font-bold mb-1">5.0</div>
                  <div className="flex gap-1 mb-1">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star key={star} className="w-5 h-5 fill-yellow-500 text-yellow-500" />
                    ))}
                  </div>
                  <div className="text-sm text-muted-foreground">25 Bewertungen</div>
                </div>
              </div>
